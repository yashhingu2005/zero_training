...
All the environments are registered in the `zero_training` extension. They start
...
import zero_training.tasks  # noqa: F401


def main():
    """Print all environments registered in `zero_training` extension."""
